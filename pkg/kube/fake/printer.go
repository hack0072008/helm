...
func (p *PrintingKubeClient) Create(resources kube.ResourceList, masquerade bool) (*kube.Result, error) {
...
func (p *PrintingKubeClient) Update(_, modified kube.ResourceList, _ bool, masquerade bool) (*kube.Result, error) {
